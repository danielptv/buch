...
INSERT INTO buch(id, version, isbn, rating, art, preis, rabatt, lieferbar, datum, homepage, schlagwoerter, titel, erzeugt, aktualisiert) OVERRIDING SYSTEM VALUE
VALUES
    -- LESEN
    ...
    (60,0,'978-3-540-43081-0',1,'KINDLE',66.6,0.066,true,'2022-02-06','https://acme.fi','TYPESCRIPT','Phi','2022-02-06 00:00:00','2022-02-06 00:00:00');
